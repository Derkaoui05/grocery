            ...
            <div class="mt-8">
                <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                    <div class="px-4 py-5 sm:px-6">
                        <h3 class="text-lg leading-6 font-medium text-gray-900">Ventes par mois</h3>
                    </div>
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-10 w-10">
                                            <img class="h-10 w-10 rounded-full" src="<?php echo $product[\'image_url\']; ?>" alt="">
                                        </div>
                                        <div class="ml-4">
                                            ...
                                            <div class="text-sm text-gray-500">
                                                <?php echo $product[\'quantity_sold\']; ?> unités vendues
                                            </div>
                                        </div>
                                    </div>
                                    <div class="text-sm text-gray-500">
